...
export const selectFavorite = (state) => state.favorites.favoritesArray;

export const selectFavoriteFilterValue = (state) =>
  state.filter.selectFavoriteFilter;

export const sortFavoritesArray = createSelector(
